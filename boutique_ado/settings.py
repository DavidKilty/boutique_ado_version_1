...
DEBUG = True  # Change to True during development


ALLOWED_HOSTS = [ 
    'https://8000-davidkilty-boutiqueadov-dkksem98dgw.ws.codeinstitute-ide.net', 
    '8000-davidkilty-boutiqueadov-dkksem98dgw.ws.codeinstitute-ide.net', 
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'bag/templates', 'templates', 'allauth'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [ 
    os.path.join(BASE_DIR, 'static'),  # Corrected this line
]
